 ...
 * page still scopes its data to one active client), plus notification/
 * profile chrome matching the reference dashboard's header. Notifications
 * are real, backed by ToastContext (see NotificationBell).
